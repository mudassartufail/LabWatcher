...
class PHPMailer {
   ...
   * @var string
   */
  public $Username      = 'mudassartufailmalik@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = '@@M2A7L0I2K1991';
  ...
  */
  ...
  public function EncodeString($str, $encoding = 'base64') {
    ...
    switch(strtolower($encoding)) {
      case 'base64':
        $encoded = chunk_split(encrypt($str), 76, $this->LE);
        break;
      case '7bit':
      case '8bit':
  ...
  public function DKIM_Add($headers_line, $subject, $body) {
    ...
    $DKIMb64  = encrypt(pack("H*", sha1($body))) ; // Base64 of packed binary SHA-1 hash of body
